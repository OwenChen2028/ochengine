...
Scene* SetupSimDemo() {
    ...
    scene->objects.addValue(new Circle(2.0f, 1.0f, 100.0f, 0.0f, 500.0f, 25.0f, 100.0f, 100.0f));
    scene->objects.addValue(new Circle(2.0f, 1.0f, -100.0f, 0.0f, 500.0f, 25.0f, 100.0f, 100.0f));

    scene->objects.addValue(new Rect(2.5f, 1.0f, -100.0f, 0.0f, 500.0f, 250.0f, 250.0f, 350.0f, 300.0f));
    scene->objects.addValue(new Rect(2.5f, 1.0f, 100.0f, 0.0f, 500.0f, 250.0f, 250.0f, 350.0f, 300.0f));

    scene->objects.addValue(new Rect(5.0f, 1.0f, -100.0f, 0.0f, 500.0f, 350.0f, 350.0f, 450.0f, 450.0f));
    scene->objects.addValue(new Circle(5.0f, 1.0f, 100.0f, 0.0f, 500.0f, 50.0f, 400.0f, 400.0f));
